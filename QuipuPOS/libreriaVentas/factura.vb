...
Public Class factura
    ...
    Public Function insertar_factura(ByVal nro_ope As Integer,
        ...
        sql = "Insert Into factura(operacion,ope_ped,cod_doc,ser_doc,nro_doc,fecha,fec_doc,fec_prod,imp_subtotal,tc,cod_mesa,cod_atencion,contacto,
                cod_vend,cod_clie,cod_fpago,cancelado,pre_inc_igv,nro_dec,cod_alma,cod_area,obs,cod_emp,cuenta,nro_ptovta,cod_doc_ref,ser_doc_ref,nro_doc_ref,usu_ins,usu_mod,fec_ins,fec_mod)" &
            "values(" &
            ...
            "','" & cod_emp & "','" & usuario & "','" & nro_ptovta & "','" & tip_doc_ref & "','" & ser_doc_ref & "','" & nro_doc_ref & "','" & usuario & "','" & usuario & "','" & mfecha1 & "','" & mfecha1 & "')"
        com.CommandText = sql
