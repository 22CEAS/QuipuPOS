...
Public Class Conexion
    Public Shared Function obtenerConexion() As MySqlConnection
        Try
            ...
            'Dim conex As String = "User Id=custom;password=h1808;server=" & "127.0.0.1" & ";database=" & "bd_ventas" &
            ...
            Dim conex As String = "User Id=custom;password=B>mb5Jw{;server=" & ConfigurationManager.AppSettings("Servidor").ToString & ";database=" & ConfigurationManager.AppSettings("BaseDatos").ToString &
                ";Convert Zero Datetime=True;persist security info=True;use procedure bodies=False;Connection Timeout=300 ; pooling=true; Max Pool Size=300"
